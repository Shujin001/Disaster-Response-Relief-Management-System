      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <Panel title="Incidents Management" icon="FlameKindling" tone="neutral" className="lg:col-span-2">
          ...
          <Link
            ...
            className="inline-block mt-3 text-xs text-brand-blueLight hover:underline"
          >
            View all incidents →
          </Link>
        </Panel>
        ...
        <Panel title="Open Volunteer Tasks" icon="Users" tone="neutral">
          ...
          <Link to="/government/rescue-teams" className="inline-block mt-3 text-xs text-brand-blueLight hover:underline">
            Manage rescue teams →
          </Link>
        </Panel>
        ...
        <Panel title="Resource Inventory" icon="PackageOpen" tone="neutral" className="lg:col-span-2">
          ...
          <Link to="/government/inventory" className="inline-block mt-3 text-xs text-brand-blueLight hover:underline">
            Manage inventory →
          </Link>
        </Panel>
